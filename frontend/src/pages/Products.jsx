  ...
  return (
    <>
                ...
                <tr key={p.id}>
                  ...
                  <td>
                    <div style={{ display: 'flex', gap: 8, justifyContent: 'flex-end' }}>
                      ...
                      <button className="btn btn-danger" style={{ padding: '8px 12px', fontSize: 13 }} onClick={() => setDeleteId(p.id)}>
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <ConfirmModal
        ...
        message="Are you sure you want to delete this product? All historical order records referencing it will also be updated."
